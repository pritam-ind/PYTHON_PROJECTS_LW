...
if page == "Home":
    ...
    st.header("Hi, I am Pritam!")
    
    st.write("I am a B.Tech student at Vivekananda Global University.")
    st.write("This dashboard shows my journey with LinuxWorld Informatics at VGU Campus")
    ...
    with col2:
        ...
        st.write("* CALCULATOR")    # i have to add the link of all repos here
        st.write("*  ATM LOGIC")
